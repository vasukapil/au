const Career = () => {
  return (
    ...
    <div className="w-[80%] h-[80%] mx-auto max-w-[1127px] max-h-[709px] bg-[url('src/Components/Home/JoinUs.png')] relative">
      <div className='max-w-[500px] max-h-[414px] flex justify-center items-center absolute left-0 bg-white bg-gradient-to-tr from-transparent via-transparent to-white border-2 border-solid border-custom-white  '>
